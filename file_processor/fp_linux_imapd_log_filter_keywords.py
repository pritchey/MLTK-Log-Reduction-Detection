...
class simPlugin(object):
	...
	# Strings to filter out of the data.
	filter_strings = ["os", "os-version", "vendor", "name", "version", "user:", "sys:", "login:", "starttls:", "counts:", "cipher", "bits", "with"]
	...
	def process_file(self, fileName):
		...
		for entry in fp:
			...
			for z in extracted[5:]:
				# Filter out field names embedded in the log line.
				if z not in self.filter_strings:
					row.append(z)
