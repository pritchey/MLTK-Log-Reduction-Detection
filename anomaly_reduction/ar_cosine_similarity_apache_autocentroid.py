...
class simPlugin(object):
	...
	def print_help(self):
		...
		"""
		return "\tName: ar_cosine_similarity_apache_autocentroid\n\t\tPerform anomaly identification and log reduction using cosine similarity.  Attempts to properly orient data based on appropriate centroid.\n"
	...
	def identify_classes(self, results, statusCode):
		...
		print("CLASSES # of ROWS %i " % classes.shape[0])
